...
class terminal {
    ...
    */
    create() {
        ...
        if(typeof arguments[0] !== 'undefined') if(typeof arguments[0] !== 'string') { $ERROR('arg type mismatch'); }
        if(typeof arguments[1] !== 'undefined') if(typeof arguments[1] !== 'object') { $ERROR('arg type mismatch'); }

        this.#create(arguments[0], arguments[1]);
    }

    #create() {
        let terminal        = $ID(this.#element),
            terminal_title  = $CREATE('div'),
            terminal_body   = $CREATE('div'),
            terminal_text   = $CREATE('div'),
            terminal_input  = $CREATE('span'),
            terminal_sign   = $CREATE('span'),
            terminal_style  = $CREATE('style');

        if (arguments[0] != null) {
            terminal = $ID(arguments[0]);
            
            this.#attr.height       = arguments[1]['height'];
            this.#attr.width        = arguments[1]['width'];
            this.#attr.opacity      = arguments[1]['opacity'];
            this.#attr.fgColor      = arguments[1]['fgColor'];
            this.#attr.bgColor      = arguments[1]['bgColor'];
            this.#attr.tlColor      = arguments[1]['tlColor'];
            this.#attr.fontName     = arguments[1]['fontName'];
            this.#attr.fontSize     = arguments[1]['fontSize'];
            this.#attr.dateOption   = arguments[1]['dateOption'];
            this.#attr.typeMode     = arguments[1]['typeMode'];
            this.#attr.readOnly     = arguments[1]['readOnly'];
        }
        ...
        `);
        $OBJ(terminal_title).ATTR('id', this.#hexID.title);
        $OBJ(terminal_title).TEXT(this.#attr.title);

        $OBJ(terminal_body).ATTR('style', `
            width: 100%;
            ...
            z-index: 1;
        `);
        $OBJ(terminal_body).ATTR('id', this.#hexID.body);
    ...
    */
    ...
    #log() {
        ...
        if(typeof arguments[0] !== 'undefined') if(typeof arguments[0] !== 'string') { $ERROR('arg type mismatch'); }
        if(typeof arguments[1] !== 'undefined') if(typeof arguments[1] !== 'string') { $ERROR('arg type mismatch'); }
    ...
    #addCommand() {
        ...
        if(typeof arguments[0] !== 'undefined') if(typeof arguments[0] !== 'string') { $ERROR('arg type mismatch'); }
        if(typeof arguments[1] !== 'undefined') if(typeof arguments[1] !== 'function') { $ERROR('arg type mismatch'); }
        if(typeof arguments[2] !== 'undefined') if(typeof arguments[2] !== 'string') { $ERROR('arg type mismatch'); }
        if(typeof arguments[3] !== 'undefined') if(typeof arguments[3] !== 'string') { $ERROR('arg type mismatch'); }
    ...
    #extraCommand() {       
        ...
        this.#addCommand('color', function () {
            ...
            {
                $ID(this.#hexID.body).STYLE.backgroundColor = `rgba(${this.#hexRGB('#' + arguments[0][1])}, ${this.#attr.opacity})`;
            }
        ...
        this.#addCommand('cookie', function () {
            ...
            if(arguments[0][1] == 'get') { this.#log(`${$COOKIE(arguments[0][2])}`); }
                ...
                if(typeof arguments[0][3] !== 'undefined') if(typeof arguments[0][2] !== 'string') { $ERROR('arg type mismatch'); } else {
